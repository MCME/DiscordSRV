...
public class LunaChatHook implements Listener {
    ...
    public LunaChatHook() {
        Legacy.hookedPlugins.add("lunachat");
    }
    ...
    public void onMessage(LunaChatChannelChatEvent event) {
        ...
        Legacy.processChatEvent(false, player, event.getNgMaskedMessage(), event.getChannel().getName());
    }
    ...
    public static void broadcastMessageToChannel(String channelName, String message, String rawMessage) {
        ...
        chatChannel.sendMessage(null, "", ChatColor.translateAlternateColorCodes('&', Legacy.plugin.getConfig().getString("ChatChannelHookMessageFormat")
