...
public class VentureChatHook implements Listener {
    ...
    public VentureChatHook() {
        Legacy.hookedPlugins.add("venturechat");
    }
    ...
    public void AsyncPlayerChatEvent(AsyncPlayerChatEvent event) {
        ...
        Legacy.processChatEvent(event.isCancelled(), event.getPlayer(), msg, eventChannel.getName());
    }
    ...
    public static void broadcastMessageToChannel(String channel, String message, String rawMessage) {
        ...
        for (MineverseChatPlayer player : playersToNotify) {
            ...
            player.getPlayer().sendMessage(ChatColor.translateAlternateColorCodes('&', Legacy.plugin.getConfig().getString("ChatChannelHookMessageFormat")
        ...
        // notify players
        Legacy.notifyPlayersOfMentions(playersToNotify.stream().map(MineverseChatPlayer::getPlayer).collect(Collectors.toList()), rawMessage);
    }
